...
void D3D12RaytracingSimpleLighting::InitializeScene()
{
	...
	// Setup lights.
	{
		...
		m_sceneCB[frameIndex].lightColor = XMLoadFloat4(&lightSpecColor);
...
void D3D12RaytracingSimpleLighting::BuildGeometry()
{
	...
	SetAttributes(1, XMFLOAT4(0, 0, 0, 0), XMFLOAT4(0.75, 0.25, 0.25, 0), XMFLOAT4(0, 0, 0, 0), XMFLOAT4(0, 0, 0, 0), XMFLOAT4(0, 0, 0, 0),
		0.1f, 0.1, 0.5);//plane
	SetAttributes(2, XMFLOAT4(0, 0, 0, 0), XMFLOAT4(0.99, 0.99, 0.01, 0), XMFLOAT4(0, 0, 0, 0), XMFLOAT4(0, 0, 0, 0), XMFLOAT4(0, 0, 0, 0),
		0.1f, 0.1, 0.1);
	SetAttributes(3, XMFLOAT4(0, 0, 0, 0), XMFLOAT4(0.99, 0.99, 0.01, 0), XMFLOAT4(0, 0, 0, 0), XMFLOAT4(0, 0, 0, 0), XMFLOAT4(0, 0, 0, 0),
		0.3f, 0.1, 0.3);
	SetAttributes(4, XMFLOAT4(0, 0, 0, 0), XMFLOAT4(0.99, 0.99, 0.01, 0), XMFLOAT4(0, 0, 0, 0), XMFLOAT4(0, 0, 0, 0), XMFLOAT4(0, 0, 0, 0),
		0.5f, 0.1, 0.5);
	SetAttributes(5, XMFLOAT4(0, 0, 0, 0), XMFLOAT4(0.99, 0.99, 0.01, 0), XMFLOAT4(0, 0, 0, 0), XMFLOAT4(0, 0, 0, 0), XMFLOAT4(0, 0, 0, 0),
		0.7f, 0.1, 0.7);
	SetAttributes(6, XMFLOAT4(0, 0, 0, 0), XMFLOAT4(0.99, 0.99, 0.01, 0), XMFLOAT4(0, 0, 0, 0), XMFLOAT4(0, 0, 0, 0), XMFLOAT4(0, 0, 0, 0),
		0.9f, 0.1, 0.9);

	//Instance 配置mesh material
	instance_map.resize(NumInstance);
	{
		...
		instance_map[2].index_MT = 2;
		instance_map[2].index_Mesh = 2;
		instance_map[3].index_MT = 3;
		instance_map[3].index_Mesh = 3;
		instance_map[4].index_MT = 4;
		instance_map[4].index_Mesh = 4;
		instance_map[5].index_MT = 5;
		instance_map[5].index_Mesh = 5;
		instance_map[6].index_MT = 6;
		instance_map[6].index_Mesh = 6;
	}
...
void D3D12RaytracingSimpleLighting::BuildAccelerationStructures()
{
   ...
   //  - from the app point of view, synchronization of writes/reads to acceleration structures is accomplished using UAV barriers.
	...
	ComPtr<ID3D12Resource> instanceDescs;
	{
		...
		instanceDesc[1].Transform[0][0] = instanceDesc[1].Transform[1][1] = instanceDesc[1].Transform[2][2] = instanceDesc[1].Transform[3][3] = 6;
		...
		instanceDesc[2].Transform[2][3] = -4;// -5;
		...
		//sphere
		instanceDesc[3].Transform[1][3] = -2;
		instanceDesc[3].Transform[0][3] = 0;
		instanceDesc[3].Transform[2][3] = -2;
		...
		instanceDesc[4].Transform[0][3] = 0;
		instanceDesc[4].Transform[2][3] = 0;
		...
		instanceDesc[5].Transform[0][3] = 0;
		instanceDesc[5].Transform[2][3] = 2;
		...
		instanceDesc[6].Transform[0][3] = 0;
		instanceDesc[6].Transform[2][3] = 4;
